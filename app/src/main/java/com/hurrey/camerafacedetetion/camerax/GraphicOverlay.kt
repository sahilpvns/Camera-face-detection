package com.hurrey.camerafacedetetion.camerax
...
import com.hurrey.camerafacedetetion.face_detection.FaceContourGraphic
...
open class GraphicOverlay(context: Context?, attrs: AttributeSet?) :
    ...
    fun add(graphic: FaceContourGraphic) {
...
private fun Any.add(element: FaceContourGraphic): Boolean {
